...
class LoginRepository:
    ...
    async def is_user_exist(self, *, conn: asyncpg.Connection, username: str) -> dict | None:
        try:
    ...
    async def register_token(self, *, conn: asyncpg.Connection, guid: str, access_token: str, refresh_token : str, expiration: datetime) -> bool:
        try:
    ...
    async def is_authorized(self, *, conn: asyncpg.Connection, guid: str, access_token: str, code: str) -> bool:
        try:
    ...
    async def revoke_token(self, *, conn: asyncpg.Connection, access_token: str) -> bool:
        try:
    ...
    async def refresh_token(self, *, conn: asyncpg.Connection, guid: str, refresh_token: str) -> str | None:
        try:
